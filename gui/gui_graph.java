...
//    	g.getNode(1).setLocation(new Point3D(1, 3));
//    	g.getNode(2).setLocation(new Point3D(10,6));
//    	g.getNode(3).setLocation(new Point3D(12, 20));
//    	g.getNode(4).setLocation(new Point3D(0,-6));
//
//    	g.connect(1, 4, 15);
//    	g.connect(4, 2, 12);
//    	g.connect(2, 3, 4);
